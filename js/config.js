...
const CONFIG = {
  ...
  LEVEL_VISUALS: {
    ...
    mine: {
      baseColor: '#071019',
      patchColor: 'rgba(2,8,16,0.42)',
      groundAlphaMin: 0.24,
      groundAlphaMax: 0.50,
      groundTileCoverage: 0.56,
      groundTintColor: 'rgba(12,44,58,0.16)',
      patchCount: 24,
      decorationCount: 18,
      sceneUnderlayAlpha: 0.34,
      wallBorderThick: 2,
      interiorWallSegments: 7,
      mapFeatures: {
        railLines: {
          count: 2,
          width: 22,
        ...
        crystalVeins: {
          ...
          radius: 54,
          clusterCount: 4,
          glowColor: 'rgba(48,210,255,0.18)',
          coreColor: 'rgba(150,245,255,0.30)',
