...
const CONFIG = {
  ...
  // ---- Per-level map visual identity ----
  // These profiles drive combat-map generation. Keep collision-heavy counts
  // moderate; visual separation should come mostly from tint, ground overlays,
  // and non-solid decoration density.
  LEVEL_VISUALS: {
    village: {
      baseColor: '#2b2117',
      terrainPattern: 'graveyardCrossroads',
      patchColor: 'rgba(24,16,8,0.28)',
      groundAlphaMin: 0.46,
      groundAlphaMax: 0.72,
      groundTileCoverage: 1,
      tileEdgeAlpha: 0.07,
      patchCount: 16,
      decorationCount: 10,
      sceneUnderlayAlpha: 0,
      wallBorderThick: 1,
      interiorWallSegments: 3,
      mapFeatures: {
        crossroads: {
          count: 1,
          width: 94,
          pathColor: 'rgba(91,67,39,0.42)',
          edgeColor: 'rgba(28,20,12,0.18)',
          rutColor: 'rgba(20,14,9,0.20)',
        },
      },
      propScatterCounts: {
        trees: 16,
    ...
    mine: {
      baseColor: '#0e1b23',
      terrainPattern: 'crackedSlate',
      useGroundTiles: false,
      patchColor: 'rgba(2,8,16,0.24)',
      groundAlphaMin: 0.08,
      groundAlphaMax: 0.22,
      groundTileCoverage: 0.16,
      groundTintColor: 'rgba(8,38,54,0.12)',
      tileEdgeAlpha: 0.03,
      patchCount: 12,
      decorationCount: 12,
      sceneUnderlayAlpha: 0,
      wallBorderThick: 2,
      interiorWallSegments: 0,
      mapFeatures: {
        railLines: {
          count: 2,
          width: 22,
          sleeperGap: 52,
          railColor: 'rgba(112,92,58,0.34)',
          sleeperColor: 'rgba(28,21,17,0.46)',
        },
        crystalVeins: {
          count: 4,
          radius: 42,
          ...
          tickRate: 0.8,
          slow: 0.84,
          glowColor: 'rgba(48,210,255,0.10)',
          coreColor: 'rgba(150,245,255,0.18)',
          shardColor: 'rgba(95,225,245,0.72)',
          rimColor: 'rgba(220,255,255,0.70)',
    ...
    hell: {
      baseColor: '#260b08',
      terrainPattern: 'basaltRifts',
      useGroundTiles: false,
      patchColor: 'rgba(88,12,4,0.16)',
      groundAlphaMin: 0.10,
      groundAlphaMax: 0.26,
      groundTileCoverage: 0.34,
      tileEdgeAlpha: 0.02,
      patchCount: 16,
      decorationCount: 20,
      sceneUnderlayAlpha: 0,
      ...
      mapFeatures: {
        lavaFissures: {
          count: 5,
          sprite: 'effects/hell_ai_lava_fissure',
          width: 34,
          damage: 12,
          tickRate: 0.6,
          slow: 0.72,
        ...
        demonRifts: {
          count: 4,
          sprite: 'effects/hell_ai_demon_rift',
          radius: 96,
          damage: 8,
          tickRate: 0.7,
          slow: 0.76,
  ...
  LEVELS: {
    ...
    mine: {
      ...
      theme: 'mine',
      bgMusic: 'mine',
      sceneBgs: ['backgrounds/scene_crystal_mine_entrance','backgrounds/scene_crystal_cave_chamber','backgrounds/scene_crystal_crystal_cavern','backgrounds/scene_crystal_track_section','backgrounds/scene_crystal_crystal_deposits','backgrounds/scene_crystal_deep_mine'],
      mapW: 36, mapH: 36,
      spawnInterval: 2.5,
      maxEnemies: 30,
      ...
      groundDecorations: ['tiles/ground_mossy_patch_01','effects/ground_crack','effects/ice_spikes_vertical','effects/ice_orb','effects/ice_shard_small','effects/spirit_orbs_blue'],
    },
    hell: {
      name: '地狱熔渊',
      theme: 'hell',
      ...
      props: {
        spikes: ['props/hell_spike_bones'],
        rocks: ['props/rocks_small_pile','props/rock_mossy_01','props/stone_fragment_01','props/hell_ai_lava_rock'],
        bones: ['props/bone_pile'],
        campfires: ['props/campfire_burnt','props/brazier_small_lit'],
        braziers: ['props/brazier_single_lit','props/brazier_double_lit','props/brazier_single_tall_lit'],
        ruins: ['props/stone_arch_broken','props/stone_pillars_01','props/stone_pillars_02'],
        houses: ['props/shrine_stone_lit'],
        stonework: ['props/stone_table_01','props/stone_fireplace','props/stone_monolith_01','props/stone_wall_doorway','props/hell_ai_demon_gate','props/hell_ai_obsidian_obelisk'],
        barrels: ['props/barrel_wooden_single'],
        platforms: ['props/wooden_platform_01'],
        watchtowers: ['props/watchtower_wooden_lit'],
        furniture: ['props/wooden_bench_broken','props/wooden_shelf_rack','props/hell_ai_chain_pile'],
      },
      ...
      groundDecorations: ['effects/ground_crack','effects/fire_projectile','effects/hell_rune_brand','effects/lava_fissure_hell','effects/hell_ai_rune_circle','effects/hell_ai_ember_burst'],
    },
  },
