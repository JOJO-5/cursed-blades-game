...
const CONFIG = {
  ...
  // ---- Weapon unlock upgrades (rare, from mimics) ----
  WEAPON_UNLOCKS: [
    { weaponId:'hammer',  name:'获得武器: 战锤', icon:'weapons/hammer' },
    { weaponId:'scythe',  name:'获得武器: 镰刀', icon:'weapons/scythe' },
    { weaponId:'bow',     name:'获得武器: 弓箭', icon:'weapons/bow' },
    { weaponId:'fireball',name:'获得武器: 火球', icon:'weapons/fireball' },
    { weaponId:'knife',   name:'获得武器: 飞刀', icon:'weapons/knife' },
    { weaponId:'soul',    name:'获得武器: 灵魂弹', icon:'weapons/soul' },
    { weaponId:'shield',  name:'获得武器: 盾牌', icon:'weapons/shield' },
    { weaponId:'ring_fire',name:'获得武器: 炎之环刃', icon:'weapons/ring_fire' },
    { weaponId:'ring_void',name:'获得武器: 虚空环刃', icon:'weapons/ring_void' },
  ],
  ...
  LEVELS: {
    village: {
      ...
      eliteInterval: 25, // seconds
      bossSpawnTime: 90,  // boss appears at 90s
      bossId: 'boss',
      chestCount: 5,
      mimicChance: 0.4,
      props: {
