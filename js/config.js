...
const CONFIG = {
  ...
  LEVEL_VISUALS: {
    ...
    mine: {
      baseColor: '#07131f',
      patchColor: 'rgba(3,12,24,0.54)',
      groundAlphaMin: 0.44,
      groundAlphaMax: 0.78,
      groundTintColor: 'rgba(32,120,150,0.22)',
      patchCount: 48,
      decorationCount: 54,
      sceneUnderlayAlpha: 0.28,
      wallBorderThick: 2,
      interiorWallSegments: 12,
      mapFeatures: {
        railLines: {
          count: 5,
          width: 50,
          sleeperGap: 28,
          railColor: 'rgba(145,112,64,0.72)',
          sleeperColor: 'rgba(30,21,16,0.82)',
        },
        crystalVeins: {
          count: 8,
          radius: 118,
          clusterCount: 8,
          glowColor: 'rgba(60,225,255,0.32)',
          coreColor: 'rgba(185,255,255,0.52)',
          shardColor: 'rgba(92,235,255,0.58)',
          rimColor: 'rgba(210,255,255,0.78)',
