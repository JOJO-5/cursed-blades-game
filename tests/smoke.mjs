...
assert.equal(Object.keys(config.ENEMIES).length, 20, 'expected 20 enemies');
...
console.log(`Smoke checks passed: ${resources.size} configured resources, 10 weapons, 20 upgrades, 20 enemies, 2 levels with phased spawning, portrait layout, pickup attraction, prerequisite system, settings overlay, story UI separation.`);
